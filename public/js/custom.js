...
(function ($) {
  'use strict';
    ...
    $(".shop-wishlist img").on('click', function () {
      if ($(this).attr("src").toString().indexOf('assets/images/blank-heart.svg') != -1) {
      this.src = this.src.replace("assets/images/blank-heart.svg", "assets/images/red-heart.svg");
      }
      else {
      this.src = this.src.replace("assets/images/red-heart.svg", "assets/images/blank-heart.svg");
      }
      });
